...
/*   Updated: 2022/06/10 11:18:57 by tel-mouh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{	
	...
	handle_img(vars, "mandatory/xpms/moves/down.xpm", \
		&vars->imgs.player.down);
	handle_img(vars, "mandatory/xpms/moves/left.xpm", &vars->imgs.player.left);
	handle_img(vars, "mandatory/xpms/moves/right.xpm", \
		&vars->imgs.player.right);
	handle_img(vars, "mandatory/xpms/collect/collect.xpm", \
		&vars->imgs.clocktibe);
